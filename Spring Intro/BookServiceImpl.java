...
import com.example.springintro.models.entities.*;
...
public class BookServiceImpl implements BookService {
    ...
    private static final String PATH_OF_BOOKS = "src/main/resources/files/books.txt";
    ...
    public void seedBooks() throws IOException {
        ...
        Files.readAllLines(Path.of(PATH_OF_BOOKS))
                .forEach(row -> {
    ...
    public List<Book> findAllBooksAfterYear(int year) {
        return bookRepository
                .findAllByReleaseDateAfter(LocalDate.of(year -1 , 12, 31));
    }
